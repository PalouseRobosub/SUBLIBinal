...
#include "System.h"
	...
	/* Enums */
	typedef enum {
		COMP_CH_1, //< Comparator 1
		COMP_CH_2, //< Comparator 2
		COMP_CH_3 //< Comparator 3
	} Comparator_Channel;
	...
	typedef struct COMPARATOR_CONFIG {
		...
		float voltage_reference; ///< The voltage reference to be used. If this is < 0 or > .75*Vdd, will use external pin
